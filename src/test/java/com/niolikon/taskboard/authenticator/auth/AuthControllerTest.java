...
class AuthControllerTest {
    ...
    @BeforeEach
    void setUp() {
        authService = mock(JwtAuthenticationService.class);
        authController = new AuthController();
        authController.setJwtAuthenticationService(authService);
    ...
    void givenValidLoginRequest_whenLogin_thenReturnsUserTokenView() {
        ...
        ResponseEntity<UserTokenView> response = authController.login(request);
    ...
    void givenValidRefreshRequest_whenRefreshToken_thenReturnsUserTokenView() {
        ...
        ResponseEntity<UserTokenView> response = authController.refreshToken(request);
